...
export const MAX_APP_SERVER_PENDING_REQUESTS = 16;
export const MAX_APP_SERVER_TURN_EVENTS = 1_024;
export const MAX_APP_SERVER_TURN_ITEMS = 64;
export const MAX_ACTIVE_HTTP_REQUESTS = 8;
export const MAX_HTTP_CONNECTIONS = 32;
